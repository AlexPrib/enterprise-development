...
public class ApplicantsService : IEntityService<Applicant, ApplicantCreateDTO, ApplicantDTO>
{
    ...
    public bool Update(ApplicantDTO updatedApplicant)
    {
        var applicant = GetById(updatedApplicant.Id);
        if (applicant == null)
        {
            return false;
        }
